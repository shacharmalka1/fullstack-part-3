...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"listen\": () => (/* binding */ listen)\n/* harmony export */ });\n/* harmony import */ var _addClick__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addClick */ \"./src/scripts/listeners/addClick.js\");\n/* harmony import */ var _modalListeners__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modalListeners */ \"./src/scripts/listeners/modalListeners.js\");\n/* harmony import */ var _tableClick__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tableClick */ \"./src/scripts/listeners/tableClick.js\");\n/* harmony import */ var _searchChange__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./searchChange */ \"./src/scripts/listeners/searchChange.js\");\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== \"undefined\" && o[Symbol.iterator] || o[\"@@iterator\"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it[\"return\"] != null) it[\"return\"](); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n\n\n\n\nvar table = document.querySelector('tbody');\nvar addButton = document.querySelector('.add');\nvar closeModal = document.querySelectorAll('.modalClose');\nvar addModal = document.querySelector('.modalAdd');\nfunction listen() {\n  table.addEventListener('click', _tableClick__WEBPACK_IMPORTED_MODULE_2__.onTableClick);\n  addButton.addEventListener('click', _addClick__WEBPACK_IMPORTED_MODULE_0__.onAddClick);\n  search.addEventListener('input', _searchChange__WEBPACK_IMPORTED_MODULE_3__.searchChange);\n\n  var _iterator = _createForOfIteratorHelper(closeModal),\n      _step;\n\n  try {\n    for (_iterator.s(); !(_step = _iterator.n()).done;) {\n      var b = _step.value;\n      b.addEventListener('click', _modalListeners__WEBPACK_IMPORTED_MODULE_1__.onCloseClick);\n    }\n  } catch (err) {\n    _iterator.e(err);\n  } finally {\n    _iterator.f();\n  }\n\n  addModal.addEventListener('click', _modalListeners__WEBPACK_IMPORTED_MODULE_1__.onAddModalClick);\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/scripts/listeners/listeners.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"searchChange\": () => (/* binding */ searchChange)\n/* harmony export */ });\n/* harmony import */ var _api_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/api */ \"./src/scripts/api/api.js\");\n/* harmony import */ var _tableClick__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tableClick */ \"./src/scripts/listeners/tableClick.js\");\n/* harmony import */ var _dom_loadTable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../dom/loadTable */ \"./src/scripts/dom/loadTable.js\");\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== \"undefined\" && o[Symbol.iterator] || o[\"@@iterator\"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it[\"return\"] != null) it[\"return\"](); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\nfunction searchChange(_x) {\n  return _searchChange.apply(this, arguments);\n}\n\nfunction _searchChange() {\n  _searchChange = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {\n    var res, personsArr, table, i, _iterator, _step, person, row;\n\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return (0,_api_api__WEBPACK_IMPORTED_MODULE_0__.getPersons)();\n\n          case 2:\n            res = _context.sent;\n            personsArr = res.data.filter(function (a) {\n              return a.name.includes(search.value);\n            });\n            table = document.querySelector('tbody');\n            table.innerHTML = '';\n            i = 0;\n            _iterator = _createForOfIteratorHelper(personsArr);\n\n            try {\n              for (_iterator.s(); !(_step = _iterator.n()).done;) {\n                person = _step.value;\n                row = (0,_dom_loadTable__WEBPACK_IMPORTED_MODULE_2__.createTableRow)(person, i);\n                table.appendChild(row);\n                i++;\n              }\n            } catch (err) {\n              _iterator.e(err);\n            } finally {\n              _iterator.f();\n            }\n\n          case 9:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n  return _searchChange.apply(this, arguments);\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/scripts/listeners/searchChange.js?");
